...
function Hero() {
  return (
    <section className="w-full mt-6 max-lg:mt-[4rem] relative overflow-hidden">
      ...
      <div className="absolute inset-0 gradient-bg opacity-20 -z-10"></div>
      ...
      <div className="mx-auto contain flex flex-col md:flex-row items-center justify-between p-5 relative">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left flex flex-col justify-center relative z-10">
          ...
          <div className="flex items-center justify-center md:justify-start gradient-bg text-white p-2 rounded-md shadow-lg max-w-fit mx-auto md:mx-0 mb-6">
          ...
          <a href="#services" className="inline-flex items-center justify-center gradient-bg text-white px-6 py-3 rounded-full shadow-md mt-6 hover:bg-yellow-500 transition-colors duration-300 ease-in-out max-w-sm">
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end relative mt-10 md:mt-0">
          <div className="relative">
            ...
            <div className="absolute top-0 left-0 w-[200px] h-[200px] gradient-bg rounded-full opacity-30 -z-10 transform -translate-x-10 -translate-y-10"></div>

            <div className="absolute bottom-0 right-0 w-[150px] h-[150px] gradient-bg  opacity-30 -z-10 transform translate-x-10 translate-y-10"></div>
