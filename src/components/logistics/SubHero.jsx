  ...
  return (
    <div className="xl:w-[70%] md:w-[80%] w-[90%] shadow-lg bg-white p-6 rounded-2xl mx-auto relative -top-16 md:py-[2rem] flex items-center justify-center">
      <div className="w-full grid md:grid-cols-3 grid-cols-1 text-center gap-6">
        <div>
          <span className="text-3xl font-bold mb-4 bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">50K+</span>
        ...
        <div>
          <span className="text-3xl font-bold mb-4 bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">1000+</span>
